...
<section class="px-16 py-8 space-y-4">
    ...
    <div class="flex gap-8 items-center flex-col-reverse lg:flex-row">
        <div class="flex-1 space-y-10">
            <p>
                We are a global asset management and disposition company, offering customers end-to-end solutions for
                buying and
                selling used heavy equipment, trucks and other assets. How the adventure ended will be seen anon. Aouda
                was
                anxious, though she said nothing. As for Passepartout, he thought Mr. Fogg’s manoeuvre simply glorious.
            </p>
            <div class="space-y-4">
                <article class="flex px-6">
                    <div class="pt-1">
                        <svg class="w-16 h-16" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                            xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 122.88 104.6"
                            style="overflow: visible;padding-top: 8px;" xml:space="preserve">
                            <style type="text/css">
                                .st0 {
                                    fill-rule: evenodd;
                                    clip-rule: evenodd;
                ...
                <article class="flex px-6">
                    <div class="pt-1">
                        <svg class="w-16 h-16" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                            ...
                            style="overflow: visible;padding-top: 10px;" xml:space="preserve">
                            <g>
                                <path
                    ...
                    <div class="space-y-3 px-6">
                        <h2 class="text-xl font-bold">Corporate Social Responsibility</h2>
                        <p>The modern world is in a continuous movement and people everywhere are looking for
                            quick, safe means of accessing accurate information. Prompt information is vital.</p>
                    </div>
                </article>
            </div>
        </div>
        <div class="flex-1">
            <img src="{{ asset('product-img.png') }}" alt="Product" class="w-full h-full object-cover">
        </div>
    </div>
